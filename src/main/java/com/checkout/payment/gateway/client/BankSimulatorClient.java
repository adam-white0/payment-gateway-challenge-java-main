  ...
  public AuthorisePaymentResponse authorisePayment(AuthorisePaymentRequest paymentRequest) {
    ...
    return restClient.post()
        ...
        .onStatus(HttpStatusCode::is5xxServerError, (req, res) -> {
          throw new PaymentAuthorisationUnavailableException(
              "Service Unavailable - Unable to authorise payment");
        })
        .onStatus(HttpStatusCode::is4xxClientError, (req, res) -> {
          throw new PaymentAuthorisationInvalidException("Request rejected - missing card details");
        })
